...
public class MovementVR_INSTICT : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        moveDirection = Quaternion.Euler(0, AxisHand.transform.eulerAngles.y, 0) * new Vector3(TrackpadAction.axis.x, 0, TrackpadAction.axis.y);
