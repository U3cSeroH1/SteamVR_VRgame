...
public class GripController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if (DomanantGrip || !ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped)
            {


                if (ConnectedObject.GetComponent<Interactable_Ins>().touchCount == 0&& !ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped)
                {
                ...
                else if (ConnectedObject.GetComponent<Interactable_Ins>().touchCount > 0|| ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped)
                {
                ...
                }else if(ConnectedObject.GetComponent<Interactable_Ins>().touchCount < 0)
                {
                    ConnectedObject.GetComponent<Interactable_Ins>().touchCount = 0;
                }
    ...
    private void Grip()
    {
        ...
        if (NewObject != null)
        {
            ...
            if (ConnectedObject.GetComponent<Interactable_Ins>().gripped)
            {
                ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped = true;
            ...
            {
                ConnectedObject.GetComponent<Interactable_Ins>().Hand = Hand;
                ConnectedObject.GetComponent<Interactable_Ins>().gripped = true;
                if (!OffsetObject.GetComponent<GrabPoint>().HelperGrip)
                {
                    DomanantGrip = true;
                    ConnectedObject.GetComponent<Interactable_Ins>().GrippedBy = transform.parent.gameObject;
                }
            }
    ...
    private void Release()
    {
        ...
        if (!ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped)
        {
            
            ConnectedObject.GetComponent<Interactable_Ins>().gripped = false;

            ConnectedObject.GetComponent<Interactable_Ins>().GrippedBy =null;

        }
        else
        {
            ConnectedObject.GetComponent<Interactable_Ins>().SecondGripped = false;
        }
